...
newObj<-meta_frame(mtcars,"mtcars dataframe",Sys.Date())
newObj$descr
...
protein("YOO",list(c(2,3),c("methylation","methylation")))


print.protein<- function(myObj) {
...
print(protein("YOO",list(c(2,3),c("methylation","methylation"))))
